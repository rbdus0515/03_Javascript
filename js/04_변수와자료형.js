...
console.log("JS 코드를 함수 내부가 아닌 JS 파일 또는 scrips 태그에 바로 작성하면 HTML 랜더링 시 바로 수행된다.")
...
// console.log(num3);
console.log(num4); // function 종료 후에도 사용가능 -> 전역변수
...
function typeTest() {
    ...
    const gender = 'M';
    typeBox.innerHTML += "<br>geander : "+ gender + " / " + typeof gender;
    ...
    for(let key in user) {
        // user 객체의 키(id,pw)를 반복할 때 마다 하나씩 얻어와 key변수에 저장하고
    ...
    typeBox.innerHTML += "<br>suFn : "+ sumFn + " / " + typeof sumfn;
